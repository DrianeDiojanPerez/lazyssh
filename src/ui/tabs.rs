...
/// The half triangles that slant a tab off at each end. The left one is filled
/// along its top, so the top edge of a tab carries on into it rather than
/// starting a cell late.
const TAB_LEFT: &str = "\u{e0bc}";
